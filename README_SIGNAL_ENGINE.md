...
BTCUSD専用の完全自動シグナルエンジン。TradingViewからWebhookでデータを受信し、AI（Claude）が最終判断を行い、Telegramにシグナルを通知します。
...
⚠️ Invalidate: M15 closes below 84750
...
| SL最大pips | `MAX_SL_PIPS` | `500` |
| 最低RR | `MIN_RR` | `0.5` |
| スプレッド閾値 | `SPREAD_THRESHOLD_PIPS` | `50.0` |
